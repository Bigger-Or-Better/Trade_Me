...
const Traders = ({ viewableTraders, currentUser }) => {
	...
	// if (viewableTraders, currentUser.length < 12){
	// 	displayTraders = viewableTraders, currentUser;
	// }
	// else{
	// 	// let shuffledArray = shuffle(viewableTraders, currentUser); //causes problems with loading
	// 	for (let i = 0; i < 12; i++){
	// 		displayTraders.push(viewableTraders, currentUser[i]);
	// 	}
	// }
